...
using WarriorsPath.Content.Items.Boss_Items.BossBags;
using WarriorsPath.Content.Items.Boss_Items.BossVanity;
using WarriorsPath.Content.Items.Boss_Items.Drops;
using WarriorsPath.Content.Items.Boss_Items.Relics;
using WarriorsPath.Content.Items.Boss_Items.Trophies;
using WarriorsPath.Content.Items.Currency;
using WarriorsPath.Content.NPCs.Bosses.DefenseMech.Healthbar;
using WarriorsPath.Content.Systems;
using WarriorsPath.Content.Tiles;



namespace WarriorsPath.Content.NPCs.Bosses.DefenseMech
{
