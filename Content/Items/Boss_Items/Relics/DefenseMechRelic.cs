...
namespace WarriorsPath.Content.Items.Boss_Items.Relics
{
	public class DefenseMechRelic : ModItem
	{
		public override void SetDefaults() {
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.Relics.DefenseMechRelic>(), 0);
